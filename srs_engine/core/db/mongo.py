...
async def init_mongo(app: Any, settings: Settings) -> None:
    ...
    try:
        ...
        logger.info("MongoDB | Indexes declared for [users, srs_jobs, diagrams, user_quotas]")
...
def get_file_storage(request: Request):
    """FastAPI dependency — returns a FileStorage instance bound to the request's DB."""
