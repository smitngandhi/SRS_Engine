...
class JobRepo:
    ...
    async def get_queue_position(self, job_id: str) -> int:
        """
        Return the 1-based position of this job in the PENDING queue.
        Position = number of PENDING jobs created before this one + 1.
        Returns 0 if job is not found or not in PENDING state.
        """
